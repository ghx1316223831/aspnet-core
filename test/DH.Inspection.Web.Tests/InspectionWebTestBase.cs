...
{
    public abstract class InspectionWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static InspectionWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(InspectionWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<InspectionDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<InspectionDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<InspectionDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<InspectionDbContext, Task<T>> func)
        {
            T result;
