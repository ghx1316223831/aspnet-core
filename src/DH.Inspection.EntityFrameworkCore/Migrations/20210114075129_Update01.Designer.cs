...
namespace DH.Inspection.Migrations
{
    ...
    [Migration("20210114075129_Update01")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DH.Inspection.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DH.Inspection.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("DH.Inspection.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("DH.Inspection.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("DH.Inspection.Authorization.Roles.Role", b =>
                {
                    b.HasOne("DH.Inspection.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("DH.Inspection.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("DH.Inspection.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
